export const TOOL_FIXTURES = [
  ...
  },
  {
    ...
    mockResponses: [
      { when: { email: 'jane@example.com' }, return: { name: 'Jane Smith', tier: 'premium', member_since: '2024-01-15', total_orders: 12 }, description: 'Premium customer' },
      { when: { email: 'bob@example.com' }, return: { name: 'Bob Wilson', tier: 'basic', member_since: '2025-06-20', total_orders: 2 }, description: 'Basic customer' },
      { when: { email: 'karen@example.com' }, return: { name: 'Karen Davis', tier: 'pro', member_since: '2025-02-10', total_orders: 5 }, description: 'Pro customer' },
